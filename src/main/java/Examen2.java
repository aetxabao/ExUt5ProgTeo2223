...
public class Examen2 {
     ...
     *         c) int[ ] copia = Arrays.copyOf(numeros, 0, copia, 0, numeros.length - 1);
     *         d) int[ ] copia = Arrays.copyOf(numeros, numeros.length);
     */
...
//        }
        System.out.println(b[2][2]+b[1][1]);
    }
    ...
    private static void ej15() {
        ...
        sb.reverse();
        System.out.println(sb.toString().substring(4,6));
    }
    ...
    private static void ej16() {
        ...
        s = a[1].substring(0,a[1].indexOf("</name>"));
        System.out.println(s);
    }
